...
public class VanExpOreFeature extends Feature<VanExpOreFeatureConfig> {
    public VanExpOreFeature(Codec<VanExpOreFeatureConfig> codec) {
        super(codec);
    }

    public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, VanExpOreFeatureConfig oreFeatureConfig) {
    ...
    protected boolean generateVeinPart(WorldAccess world, Random random, VanExpOreFeatureConfig config, double startX, double endX, double startZ, double endZ, double startY, double endY, int x, int y, int z, int size, int i) {
        int j = 0;
